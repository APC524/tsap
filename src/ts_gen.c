...
__PYX_EXTERN_C DL_IMPORT(void) c_ar1_gen(double *, double, double, int, int, int); /*proto*/
 ...
 *     return out
 */
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_burnin); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = PySlice_New(__pyx_t_1, Py_None, Py_None); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_GetItem(((PyObject *)__pyx_v_data), __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 23, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_out = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "tsap/src/ts_gen.pyx":25
 *     out = data[:, burnin: ]
 * 
 *     return out             # <<<<<<<<<<<<<<
 */
 ...
 *     generate AR(1) data, rho is the coefficient
 */
  __pyx_tuple__11 = PyTuple_Pack(7, __pyx_n_s_rho, __pyx_n_s_sigma, __pyx_n_s_time, __pyx_n_s_num, __pyx_n_s_burnin, __pyx_n_s_data, __pyx_n_s_out); if (unlikely(!__pyx_tuple__11)) __PYX_ERR(0, 12, __pyx_L1_error)
